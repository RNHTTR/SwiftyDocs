...
class FontDetailViewController: UIViewController, SideBarDelegate {
    ...
    override func viewDidLoad() {
        ...
        let palettePickerAttributes = [NSAttributedStringKey.font: UIFont(name: "AppleColorEmoji", size: 25) as Any]
...
//extension FontDetailViewController@objc  {
extension FontDetailViewController  {
    @objc func selectPalette() {
...
extension FontDetailViewController {
    ...
    func setNew(palette: ColorPalette.ColorPaletteType) {
        ...
        case .bold:
            ...
            button2?.backgroundColor         = ColorPalette.Bold.indigo
            button3?.backgroundColor         = ColorPalette.Bold.purple
            button4?.backgroundColor         = ColorPalette.Bold.blue
            button5?.backgroundColor         = ColorPalette.Bold.red
            button6?.backgroundColor         = ColorPalette.Bold.green
            button7?.backgroundColor         = ColorPalette.Bold.yellow
            whiteButton?.backgroundColor     = ColorPalette.Bold.white
        case .bright:
            blackButton?.backgroundColor     = ColorPalette.Bright.black
            button2?.backgroundColor         = ColorPalette.Bright.indigo
            button3?.backgroundColor         = ColorPalette.Bright.purple
            button4?.backgroundColor         = ColorPalette.Bright.blue
            button5?.backgroundColor         = ColorPalette.Bright.red
            button6?.backgroundColor         = ColorPalette.Bright.green
            button7?.backgroundColor         = ColorPalette.Bright.yellow
            whiteButton?.backgroundColor     = ColorPalette.Bright.white
        case .light:
            blackButton?.backgroundColor     = ColorPalette.Light.black
            button2?.backgroundColor         = ColorPalette.Light.indigo
            button3?.backgroundColor         = ColorPalette.Light.purple
            button4?.backgroundColor         = ColorPalette.Light.blue
            button5?.backgroundColor         = ColorPalette.Light.red
            button6?.backgroundColor         = ColorPalette.Light.green
            button7?.backgroundColor         = ColorPalette.Light.yellow
